...
NEWS = MonitorTheme(
    ...
    keywords={
        ...
        "ramjet": [
            ...
            # Gel/paste ramjet (凝胶冲压)
            "凝胶冲压发动机", "凝胶冲压", "gel ramjet",
            "凝胶推进剂", "gelled propellant", "凝胶燃料", "gel fuel",
            "煤油凝胶", "kerosene gel", "凝胶化煤油", "gelled kerosene",
            "含能凝胶", "energetic gel", "金属化凝胶", "metallized gel",
            "胶凝剂", "gelling agent", "凝胶化", "gelation",
            "触变推进剂", "thixotropic propellant", "剪切稀化",
            "非牛顿推进剂", "non-Newtonian propellant",
            # Paste ramjet (膏体冲压)
            "膏体冲压发动机", "膏体冲压", "paste ramjet",
            "膏体推进剂", "paste propellant", "膏状燃料", "paste fuel",
            "半固体推进剂", "semi-solid propellant",
            "膏体喷射", "paste injection",
            # Powdered fuel ramjet (粉末冲压)
            "粉末冲压发动机", "粉末冲压", "powdered fuel ramjet",
            "粉末燃料", "powdered fuel", "粉末燃料冲压",
            "含能粉末", "energetic powder", "粉末喷射", "powder injection",
            "粉末供给", "powder feeding", "粉末点火", "powder ignition",
            "颗粒燃料", "particulate fuel", "离散颗粒",
            # Water ramjet / aluminum-water ramjet (水冲压)
            "水冲压发动机", "水冲压", "water ramjet",
            "铝水冲压", "aluminum-water ramjet", "铝水反应", "aluminum-water reaction",
            "金属水反应", "metal-water reaction",
            "水反应金属燃料", "water-reactive metal fuel",
            "水反应推进剂", "water-reactive propellant",
            "水下冲压", "underwater ramjet",
            "镁水反应", "magnesium-water reaction",
        ],
...
DW = MonitorTheme(
    ...
    keywords={
        ...
        "general_defense": [
            ...
            "超音速", "超音速飞行",
            # 军机型号前缀
            "B-2", "B-21", "F-35", "F-22", "F-15", "F-16", "F-18",
            "C-17", "C-130", "C-5",
            "P-8", "P-3",
            "MQ-", "RQ-", "KC-", "E-2", "E-3", "E-7", "RC-",
            "AH-", "CH-", "UH-", "V-22",
            # 通用舰艇
            "两栖", "舰艇", "两栖攻击舰", "两栖作战",
            "巡洋舰", "登陆舰", "补给舰",
            # 中国舰艇型号
            "055型", "052D", "054A", "054B", "075型", "076型",
            # 太空
            "太空", "星座", "星链", "星盾", "太空经济",
            "轨道", "航天器", "运载火箭", "可复用火箭",
            "千帆", "低轨星座",
